...
# data path (Training set)

train_img_list_path <- 'pikachu/data/train_img_list.RData'
train_box_info_path <- 'pikachu/data/train_box_info.RData'

if (!'train_img_list' %in% ls()) {
  
  # Load data
  
  load(train_img_list_path)
  load(train_box_info_path)
